...
void setupgc() {
	...
	examplegcrd2.actual_record = (void *) &examplegcac2;
	examplegcac2.amount_added = 1000;
	examplegcac2.actual_signature = "[ insert crypto signature here ]";	
